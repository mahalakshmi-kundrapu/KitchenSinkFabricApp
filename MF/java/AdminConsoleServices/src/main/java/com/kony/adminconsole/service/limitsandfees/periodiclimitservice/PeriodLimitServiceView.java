...
public class PeriodLimitServiceView implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest requestInstance,
		...
		try {
			JSONObject readResJSON = getPeriodicLimitsForService(serviceId, authToken, requestInstance);
			if (readResJSON.getInt(FabricConstants.OPSTATUS) != 0) {
				return ErrorCodeEnum.ERR_20818.setErrorCode(result);
			}
			JSONArray periodicLimitsService = (JSONArray) readResJSON.get("periodiclimitservice_view");
	...
	public JSONObject getPeriodicLimitsForService(String serviceId, String authToken,
		...
		String readEndpointResponse = Executor.invokeService(
				ServiceURLEnum.PERIODICLIMITSERVICE_VIEW_READ, postParametersMap,
