...
public class AdminActivityMasterDataGetService implements JavaService2 {

    private static final Logger LOG = Logger.getLogger(AdminActivityMasterDataGetService.class);
    ...
    public Object invoke(String methodID, Object[] inputArray, DataControllerRequest requestInstance,
        ...
        try {
            ...
            jsonObject.put("Events", EventEnum.getAllEventAliases());
            jsonObject.put("ModuleNames", ModuleNameEnum.getAllModuleAliases());
            jsonObject.put("Status", ActivityStatusEnum.getAdminStatusAliases());
            ...
            result.addParam(new Param("ModuleNames", finalJSONResult.get("ModuleNames").toString()));
