...
public class GroupFeaturesAndActionsGet implements JavaService2 {

	private static final Logger LOG = Logger.getLogger(GroupFeaturesAndActionsGet.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest requestInstance,
		...
		try {
			...
			groupActions.forEach((actionObject) -> {
				GroupActionLimitView action = FeatureandActionHandler.getGroupActionObject((JSONObject) actionObject);
