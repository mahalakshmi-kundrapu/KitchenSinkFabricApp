...
public class FetchVehicleModelsCallable implements Callable<JSONObject> {
	...
	/**
	 * Number of years calls has to be initiated for
	 */
	private final int totalyears=Integer.parseInt(VEHICLECONFIGPROP.getString("totalyears"));
	
	FetchVehicleModelsCallable(JSONObject param1, DataControllerRequest param2){
		this.object=param1;
	...
	public JSONObject call() throws Exception {
		try{
			...
			for(int year=currentDate.getYear()+1;year>currentDate.getYear()+1-totalyears;year--){
				try{
