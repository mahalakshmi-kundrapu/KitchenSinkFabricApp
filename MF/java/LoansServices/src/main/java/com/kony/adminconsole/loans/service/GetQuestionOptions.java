...
public class GetQuestionOptions implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray,
        ...
        String Value = Executor.invokeService(LoansServiceURLEnum.QUESTION_OPTIONS_GET, (HashMap<String, String>) inputParams, null, dcRequest);
